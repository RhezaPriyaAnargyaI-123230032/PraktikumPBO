...
public class PembelianDVD extends JFrame implements ActionListener {
    ...
    public PembelianDVD(String jenisDVD, double harga, String username) {
        this.harga = harga;
    ...
    public void actionPerformed(ActionEvent e) {
        try {
            if (e.getSource() == beli) {
                ...
                double hargaSetelahPajak = totalHarganya + pajak;
                
                jumlahTotal.setText(jumlah + " pcs");
                PPN.setText("Rp " + pajak);
                totalHarga.setText("Rp " + hargaSetelahPajak);
